...
Piece::Piece(string userColor, char pieceType) {
  ...
  if (userColor == "white") {  // establishing color
    // displayCode = "\e[38;5;15m";  // changes background color in unix terminal (for unix terminal)
    displayCode = " w";              // for non-unix terminal
  } else if (userColor == "black") {
    // displayCode = "\e[38;5;232m"; // changes background color in unix terminal (for unix terminal)
    displayCode = " b";              // for non-unix terminal
  } else {
    displayCode = "ERROR";
    cout << displayCode << endl;
  }

  // displayCode += " "; // for unix terminal
  if (pieceType == 'K') {  // establishing piece type.
    displayCode += "K ";
  } else if (pieceType == 'Q') {
    displayCode += "Q ";
  } else if (pieceType == 'R') {
...
const int ROWS = 8;
const int COLUMNS = 8;
// const string whiteBG = "\e[48;5;7m";    // changes bg/fg color in unix terminal
...
// const string empty = "   ";
const string whiteBG = "";    // changes bg/fg color in unix terminal
